...
#define AUTOCONF_SYSNAME "linux-androideabi"

/* "Software build year" */
#define BUILD_YEAR 2014
...
/* Define to 1 if you have the declaration of `pthread_sigmask', and to 0 if
   you don't. */
#define HAVE_DECL_PTHREAD_SIGMASK 0
...
/* Logdir location */
#define LOGDIR "/data/rudder/cfengine-community"
...
/* piddir location */
#define PIDDIR "/data/rudder/cfengine-community"
...
#define SHELL_PATH "/system/xbin/sh"
...
#define VERSION "3.6.0b2.4d16d93"
